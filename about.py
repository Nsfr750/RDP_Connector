...
class About:
    ...
    def show_about(root):
        ...
        title = ttk.Label(about_dialog, text='RDP Connector', font=('Helvetica', 16, 'bold'))
        title.pack(pady=20)
        ...
        description = ttk.Label(about_dialog, text='Linux to Windows RDP Connector.', justify=tk.CENTER)
